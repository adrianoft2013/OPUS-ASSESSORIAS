-- =========================================================================
-- MIGRAÇÃO CONSOLIDADA E SEGURA (COPIAR E EXECUTAR NO SUPABASE)
-- Nome do Projeto: OpusAssessorias
-- Data: 2026-07-02
-- Objetivo: Garantir que todas as tabelas, colunas, índices, políticas (RLS) e
--            triggers existam sem NUNCA deletar ou perder os dados existentes.
-- =========================================================================
...
-- Garantir colunas específicas de controle (utilizando ALTER TABLE ADD COLUMN IF NOT EXISTS para nunca perder dados de tabelas existentes)
...
-- Comentários explicativos para as novas colunas
COMMENT ON COLUMN public.employees.service_order IS 'Ordem de Serviço (Conforme / Não Conforme).';
COMMENT ON COLUMN public.employees.registration_record IS 'Ficha de Registro (Conforme / Não Conforme).';
COMMENT ON COLUMN public.employees.employment_contract IS 'Contrato de Trabalho (Conforme / Não Conforme).';
...
-- =========================================================================
-- 8. CRIAÇÃO DE ÍNDICES PARA OTIMIZAÇÃO DE BUSCAS E JOINS (IF NOT EXISTS)
-- =========================================================================
